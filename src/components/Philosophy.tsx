...
export default function Philosophy() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="sacred-spin-slow absolute pointer-events-none"
        style={{
          right: '-14%',
          top: '50%',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="reveal mb-8 max-w-4xl">
          ...
          >
            Simplicity. It's a standard.
          </p>
        </div>

        {/* Body copy */}
        <p
          className="reveal font-epilogue leading-relaxed mb-24 max-w-2xl"
          style={{
        ...
        {/* 2×2 pillar grid — staggered */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px">
          {pillars.map((pillar, i) => (
            <div
              key={pillar.number}
              className={`pillar-card reveal p-10 lg:p-12 ${
                i === 1 ? 'md:mt-16' : ''
              } ${i === 3 ? 'md:mt-16' : ''}`}
            >
              {/* Number */}
              <span
                className="block font-mono text-sm mb-6"
                style={{ color: '#D4907A' }}
              >
                {pillar.number}
              </span>
              ...
              {/* Name */}
              <h3
                className="font-epilogue font-black uppercase text-parchment mb-5"
                style={{
